...
function marcadorGasolina()
    if not IsPedOnFoot(PlayerPedId()) then
        ...
        if Gasosa >= 0.0 and Gasosa < 5.0 then
            drawText2("Gasolina = ~g~Cheio", 4, 0.2240, 0.8750, 0.0000, 0.3790)
        elseif Gasosa >= 5.0 and Gasosa < 12.0 then
            drawText2("Gasolina = ~y~Metade", 4, 0.2240, 0.8750, 0.0000, 0.3790)
        elseif Gasosa >= 12.0 and Gasosa < 14.0 then
            drawText2("Gasolina = ~r~Reserva (encontre um posto de gasolina)", 4, 0.2240, 0.8750, 0.0000, 0.3790);
        elseif Gasosa >= 14.0 then
            drawText2("Gasolina = ~p~Vazio, precisa abastecer agora", 4, 0.2240, 0.8750, 0.0000, 0.3790);
			SetVehiclePetrolTankHealth(GetVehiclePedIsIn(PlayerPedId(), 0), 600.0);
        else
            print("Número fora do intervalo esperado")
        end
