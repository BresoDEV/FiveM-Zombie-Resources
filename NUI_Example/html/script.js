...
props.forEach(e => {
    ...
    o.value=e
    o.innerHTML=e
    document.getElementById('selectProps').appendChild(o)
   // str+='<option value="'+e+'">'+e+'</option>'
});

document.getElementById('selectProps').addEventListener('input',()=>{
    //propSpawnNome
    document.getElementById('propSpawnNome').value=document.getElementById('selectProps').value
})